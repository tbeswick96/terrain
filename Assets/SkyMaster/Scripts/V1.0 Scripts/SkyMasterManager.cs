							...
							for (int n = 0; n < ParticleOBJ_Ps.Length; n++){
								if(ParticleOBJ_Ps[n].maxParticles < max_particles){
									...
									if(ParticleOBJ_Ps[n].startColor.a < Transp){									
										ParticleOBJ_Ps[n].startColor = new Color(ParticleOBJ_Ps[n].startColor.r,ParticleOBJ_Ps[n].startColor.g,ParticleOBJ_Ps[n].startColor.b,ParticleOBJ_Ps[n].startColor.a+0.08f*rate*Time.deltaTime);//v3.2 - changed from 0.02f
									}
								}
...
public class SkyMasterManager : MonoBehaviour 
{
        ...
        public static SkyMasterManager instance;
...
//						}
								...
								if(Star_particles_OBJ_P!=null){
									if(Star_particles_OBJ_P.maxParticles>5){
										...
										if(Random.Range(1,27)==2){
											Star_particles_OBJ_P.maxParticles -=Mathf.Max(1,(int)(5 * DawnAppearSpeed * 0.5f));//v3.1
										}
										Star_particles_OBJ_P.startColor = Color.Lerp(Star_particles_OBJ_P.startColor,new Color(Star_particles_OBJ_P.startColor.r,Star_particles_OBJ_P.startColor.g,Star_particles_OBJ_P.startColor.b,0),Time.deltaTime*StarsPFadeSpeed* DawnAppearSpeed*SPEED);
									}else{
										if(Star_particles_OBJ_P.gameObject.activeInHierarchy){
											Star_particles_OBJ_P.gameObject.SetActive(false);
										}
							...
							if( (AutoSunPosition && Rot_Sun_X < 0  ) | (!AutoSunPosition &&  Current_Time > (NightTimeMax+Shift_dawn) | (Current_Time >= 0 & Current_Time <=(1+Shift_dawn))) ){ //v3.0.4
								...
								if(Star_particles_OBJ_P.maxParticles < 1000){
									Star_particles_OBJ_P.maxParticles +=5;
									//v3.1
										Star_particles_OBJ_P.startColor = Color.Lerp(Star_particles_OBJ_P.startColor,new Color(Star_particles_OBJ_P.startColor.r,Star_particles_OBJ_P.startColor.g,Star_particles_OBJ_P.startColor.b,StarsPMaxGlow),Time.deltaTime*0.6f*SPEED);
								}
								}else{
									if(!Star_particles_OBJ.activeInHierarchy){
										Star_particles_OBJ.SetActive(true);
